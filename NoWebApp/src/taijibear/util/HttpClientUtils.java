...
public class HttpClientUtils {
  ...
  public static String httpsPostInvoke(String url, Map<String, String> params)
	      throws URISyntaxException, ClientProtocolException, IOException {
	    return httpsPostInvoke(url, params,CONTENT_CHARSET);
	  }
  ...
  public static String httpsPostInvoke(String url, Map<String, String> params,String charset)
	      throws URISyntaxException, ClientProtocolException, IOException {
